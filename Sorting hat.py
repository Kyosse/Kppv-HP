# -*- coding: utf-8 -*- Programme pour choisir la maison par le choipeaux magique avec l'aide du Kppv
import csv
...
student4 = {'Name': 'eleve4', 'Courage': 2, 'Ambition': 3, 'Intelligence': 7, 'Good': 8}
 ...
 #initialisation de la variable en globale

def create_table():
    """
    fusion des deux ficiers(ajout de la maison)
        sortie : tab = les tableau avec toutes les caracteristiques
...
def add_distance(tab, student_selected):
    ...
    entrée : tab = liste de dictionnaire
             student_selected = dictionnaire de l'élève référentiel(choisie)
...
students_features = create_table()
put_the_sorting_hat(students_features, student1, val_k)
put_the_sorting_hat(students_features, student2, val_k)
put_the_sorting_hat(students_features, student3, val_k)
put_the_sorting_hat(students_features, student4, val_k)
...
if qtn_personnaliser == 'oui' or qtn_personnaliser == 'Oui' :
    ...
    val_k = int(input('Choisir la valeur de k = '))
